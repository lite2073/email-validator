...
public class DNSLookupTest {
	...
	public void doLookupTest() throws DNSLookupException {
		...
		assertEquals(5, DNSLookup.doLookup("google.de", "MX"));
		assertEquals(1, DNSLookup.doLookup("yahoo.de", "MX"));
		...
		assertEquals(6, DNSLookup.doLookup("whitehouse.gov", "MX"));

		assertEquals(0, DNSLookup.doLookup("us.ibm.com", "A"));
		assertEquals(15, DNSLookup.doLookup("us.ibm.com", "MX"));
	}
}
